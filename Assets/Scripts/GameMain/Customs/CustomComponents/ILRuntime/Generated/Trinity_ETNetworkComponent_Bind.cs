...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Trinity_ETNetworkComponent_Binding
    {
        ...
        static StackObject* CreateSession_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Trinity.ETNetworkComponent instance_of_this_method = (Trinity.ETNetworkComponent)typeof(Trinity.ETNetworkComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        {
            var result_of_this_method = ((Trinity.ETNetworkComponent)o).ServerIP;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }
        ...
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            System.String @ServerIP = (System.String)typeof(System.String).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ((Trinity.ETNetworkComponent)o).ServerIP = @ServerIP;
