...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityGameFramework_Runtime_EventComponent_Binding
    {
        ...
        static StackObject* Subscribe_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.EventHandler<GameFramework.Event.GameEventArgs> @handler = (System.EventHandler<GameFramework.Event.GameEventArgs>)typeof(System.EventHandler<GameFramework.Event.GameEventArgs>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            ...
            UnityGameFramework.Runtime.EventComponent instance_of_this_method = (UnityGameFramework.Runtime.EventComponent)typeof(UnityGameFramework.Runtime.EventComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
