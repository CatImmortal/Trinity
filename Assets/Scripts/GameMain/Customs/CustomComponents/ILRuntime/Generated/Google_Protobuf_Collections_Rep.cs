...
{
    unsafe class Google_Protobuf_Collections_RepeatedField_1_Google_Protobuf_IMessageAdaptor_Binding_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Google.Protobuf.Collections.RepeatedField<Google.Protobuf.IMessageAdaptor.Adaptor>);
            args = new Type[]{typeof(Google.Protobuf.CodedOutputStream), typeof(Google.Protobuf.FieldCodec<Google.Protobuf.IMessageAdaptor.Adaptor>)};
            method = type.GetMethod("WriteTo", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WriteTo_0);
            args = new Type[]{typeof(Google.Protobuf.FieldCodec<Google.Protobuf.IMessageAdaptor.Adaptor>)};
            ...
            args = new Type[]{typeof(Google.Protobuf.CodedInputStream), typeof(Google.Protobuf.FieldCodec<Google.Protobuf.IMessageAdaptor.Adaptor>)};
        ...
        static StackObject* WriteTo_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.Protobuf.FieldCodec<Google.Protobuf.IMessageAdaptor.Adaptor> @codec = (Google.Protobuf.FieldCodec<Google.Protobuf.IMessageAdaptor.Adaptor>)typeof(Google.Protobuf.FieldCodec<Google.Protobuf.IMessageAdaptor.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            Google.Protobuf.Collections.RepeatedField<Google.Protobuf.IMessageAdaptor.Adaptor> instance_of_this_method = (Google.Protobuf.Collections.RepeatedField<Google.Protobuf.IMessageAdaptor.Adaptor>)typeof(Google.Protobuf.Collections.RepeatedField<Google.Protobuf.IMessageAdaptor.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Google.Protobuf.Collections.RepeatedField<Google.Protobuf.IMessageAdaptor.Adaptor>();
