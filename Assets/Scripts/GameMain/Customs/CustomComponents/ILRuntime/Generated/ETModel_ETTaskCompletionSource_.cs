...
{
    unsafe class ETModel_ETTaskCompletionSource_1_Google_Protobuf_IMessageAdaptor_Binding_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.ETTaskCompletionSource<Google.Protobuf.IMessageAdaptor.Adaptor>);
            args = new Type[]{};
        ...
        static StackObject* get_Task_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ETTaskCompletionSource<Google.Protobuf.IMessageAdaptor.Adaptor> instance_of_this_method = (ETModel.ETTaskCompletionSource<Google.Protobuf.IMessageAdaptor.Adaptor>)typeof(ETModel.ETTaskCompletionSource<Google.Protobuf.IMessageAdaptor.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* SetResult_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Google.Protobuf.IMessageAdaptor.Adaptor @result = (Google.Protobuf.IMessageAdaptor.Adaptor)typeof(Google.Protobuf.IMessageAdaptor.Adaptor).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new ETModel.ETTaskCompletionSource<Google.Protobuf.IMessageAdaptor.Adaptor>();
