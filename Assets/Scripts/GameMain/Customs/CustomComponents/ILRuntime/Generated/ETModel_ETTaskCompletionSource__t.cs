...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ETTaskCompletionSource_1_Google_Protobuf_IMessageAdaptor_Binding_Adaptor_Binding
    {
        ...
        static StackObject* get_Task_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.ETTaskCompletionSource<Google.Protobuf.IMessageAdaptor.Adaptor> instance_of_this_method = (ETModel.ETTaskCompletionSource<Google.Protobuf.IMessageAdaptor.Adaptor>)typeof(ETModel.ETTaskCompletionSource<Google.Protobuf.IMessageAdaptor.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
