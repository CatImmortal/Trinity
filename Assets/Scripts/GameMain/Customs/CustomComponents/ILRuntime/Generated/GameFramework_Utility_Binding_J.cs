...
{
    unsafe class GameFramework_Utility_Binding_Json_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GameFramework.Utility.Json);
        ...
        static StackObject* ToJson_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = GameFramework.Utility.Json.ToJson(@obj);
