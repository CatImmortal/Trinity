...
namespace Trinity.Editor
{
    ...
    public class ReferenceCollectorEditor : UnityEditor.Editor
    {
        ...
        private List<KeyValuePair<string, string>> prefixesMap = new List<KeyValuePair<string, string>>
        {
            ...
            new KeyValuePair<string, string>("Canvas","Canvas"),
            ...
            new KeyValuePair<string, string>("TGroup","ToggleGroup"),
            ...
            new KeyValuePair<string, string>("Slider","Slider"),
            new KeyValuePair<string, string>("Mask","Mask"),
            new KeyValuePair<string, string>("Mask2D","RectMask2D"),
            new KeyValuePair<string, string>("Tog","Toggle"),
            new KeyValuePair<string, string>("Sbar","Scrollbar"),
            new KeyValuePair<string, string>("SRect","ScrollRect"),
        };
