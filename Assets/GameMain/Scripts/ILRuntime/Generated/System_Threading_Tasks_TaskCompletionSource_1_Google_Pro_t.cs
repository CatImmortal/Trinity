...
{
    unsafe class System_Threading_Tasks_TaskCompletionSource_1_Google_Protobuf_IMessageAdaptor_Binding_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Threading.Tasks.TaskCompletionSource<Google.Protobuf.IMessageAdaptor.Adaptor>);
            args = new Type[]{};
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Threading.Tasks.TaskCompletionSource<Google.Protobuf.IMessageAdaptor.Adaptor>();
