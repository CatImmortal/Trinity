...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_Collections_RepeatedField_1_Google_Protobuf_IMessageAdaptor_Binding_Adaptor_Binding
    {
        ...
        static StackObject* WriteTo_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.Protobuf.FieldCodec<Google.Protobuf.IMessageAdaptor.Adaptor> @codec = (Google.Protobuf.FieldCodec<Google.Protobuf.IMessageAdaptor.Adaptor>)typeof(Google.Protobuf.FieldCodec<Google.Protobuf.IMessageAdaptor.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            Google.Protobuf.Collections.RepeatedField<Google.Protobuf.IMessageAdaptor.Adaptor> instance_of_this_method = (Google.Protobuf.Collections.RepeatedField<Google.Protobuf.IMessageAdaptor.Adaptor>)typeof(Google.Protobuf.Collections.RepeatedField<Google.Protobuf.IMessageAdaptor.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
