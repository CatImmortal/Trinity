...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Trinity_ILRuntimeComponent_Binding
    {
        ...
        static StackObject* GetHotfixTypes_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Trinity.ILRuntimeComponent instance_of_this_method = (Trinity.ILRuntimeComponent)typeof(Trinity.ILRuntimeComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
