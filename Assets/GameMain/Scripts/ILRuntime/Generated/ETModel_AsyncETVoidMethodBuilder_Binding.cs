...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_AsyncETVoidMethodBuilder_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(Trinity.IAsyncStateMachineAdaptor.Adaptor)};
            if (genericMethods.TryGetValue("Start", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(Trinity.IAsyncStateMachineAdaptor.Adaptor).MakeByRefType()))
                    {
            ...
            args = new Type[]{typeof(ETModel.ETTask.Awaiter), typeof(Trinity.IAsyncStateMachineAdaptor.Adaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ETModel.ETTask.Awaiter).MakeByRefType(), typeof(Trinity.IAsyncStateMachineAdaptor.Adaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(ETModel.ETTask<ETModel.IResponse>.Awaiter), typeof(Trinity.IAsyncStateMachineAdaptor.Adaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(ETModel.ETTask<ETModel.IResponse>.Awaiter).MakeByRefType(), typeof(Trinity.IAsyncStateMachineAdaptor.Adaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.Start<Trinity.IAsyncStateMachineAdaptor.Adaptor>(ref @stateMachine);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as Trinity.IAsyncStateMachineAdaptor.Adaptor[];
        ...
        static StackObject* AwaitUnsafeOnCompleted_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.AwaitUnsafeOnCompleted<ETModel.ETTask.Awaiter, Trinity.IAsyncStateMachineAdaptor.Adaptor>(ref @awaiter, ref @stateMachine);
        ...
        static StackObject* AwaitUnsafeOnCompleted_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.AwaitUnsafeOnCompleted<ETModel.ETTask<ETModel.IResponse>.Awaiter, Trinity.IAsyncStateMachineAdaptor.Adaptor>(ref @awaiter, ref @stateMachine);
