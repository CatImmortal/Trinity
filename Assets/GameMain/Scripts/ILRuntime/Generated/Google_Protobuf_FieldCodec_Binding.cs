...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Google_Protobuf_FieldCodec_Binding
    {
        ...
        static StackObject* ForMessage_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.Protobuf.MessageParser<Google.Protobuf.IMessageAdaptor.Adaptor> @parser = (Google.Protobuf.MessageParser<Google.Protobuf.IMessageAdaptor.Adaptor>)typeof(Google.Protobuf.MessageParser<Google.Protobuf.IMessageAdaptor.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
