...
{
    unsafe class ETModel_R2C_RPCTest_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ETModel.R2C_RPCTest);
            args = new Type[]{};
        ...
        static StackObject* get_Text_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.R2C_RPCTest instance_of_this_method = (ETModel.R2C_RPCTest)typeof(ETModel.R2C_RPCTest).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
