...
namespace Trinity.Editor
{
    ...
    public class AutoGenEventCodeEditorWindow : EditorWindow
    {
        [MenuItem("Trinity/自动生成事件参数类的代码")]
        public static void OpenAutoGenWindow()
        {
            
            AutoGenEventCodeEditorWindow window = GetWindow<AutoGenEventCodeEditorWindow>(true, "自动生成事件参数类代码");
        ...
        private const string HotfixEventCodePath = "Assets/GameMain/Scripts/Hotfix/Event";
