...
namespace Trinity.Editor
{
	...
	public class Proto2CSEditor : EditorWindow
	{
		...
		private const string clientMessagePath = "Assets/GameMain/Libraries/ET/Module/Message/";
		private const string hotfixMessagePath = "Assets/GameMain/Scripts/Hotfix/ETNetwork/Module/Message/";
		private static readonly char[] splitChars = { ' ', '\t' };
		private static readonly List<OpcodeInfo> msgOpcode = new List<OpcodeInfo>();
		
		[MenuItem("Trinity/Proto2CS")]
