...
{
    unsafe class Trinity_UIExtension_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Trinity.UIExtension);
            args = new Type[]{typeof(UnityGameFramework.Runtime.UIComponent), typeof(Trinity.UIFormId), typeof(System.Object)};
        ...
        static StackObject* OpenUIForm_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Trinity.UIFormId @uiFormId = (Trinity.UIFormId)typeof(Trinity.UIFormId).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            var result_of_this_method = Trinity.UIExtension.OpenUIForm(@uiComponent, @uiFormId, @userData);
