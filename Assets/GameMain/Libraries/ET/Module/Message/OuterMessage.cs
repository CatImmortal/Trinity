...
namespace ETModel {
  ...
  public partial class RPCTestRequest : pb::IMessage {
    private static readonly pb::MessageParser<RPCTestRequest> _parser = new pb::MessageParser<RPCTestRequest>(() => (RPCTestRequest)MessagePool.Instance.Fetch(typeof(RPCTestRequest)));
    public static pb::MessageParser<RPCTestRequest> Parser { get { return _parser; } }
  ...
  public partial class RPCTestResponse : pb::IMessage {
    private static readonly pb::MessageParser<RPCTestResponse> _parser = new pb::MessageParser<RPCTestResponse>(() => (RPCTestResponse)MessagePool.Instance.Fetch(typeof(RPCTestResponse)));
    public static pb::MessageParser<RPCTestResponse> Parser { get { return _parser; } }
