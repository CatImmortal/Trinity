...
namespace ETModel {
  ...
  public partial class C2R_RPCTest : pb::IMessage {
    private static readonly pb::MessageParser<C2R_RPCTest> _parser = new pb::MessageParser<C2R_RPCTest>(() => (C2R_RPCTest)MessagePool.Instance.Fetch(typeof(C2R_RPCTest)));
    public static pb::MessageParser<C2R_RPCTest> Parser { get { return _parser; } }
  ...
  public partial class R2C_RPCTest : pb::IMessage {
    private static readonly pb::MessageParser<R2C_RPCTest> _parser = new pb::MessageParser<R2C_RPCTest>(() => (R2C_RPCTest)MessagePool.Instance.Fetch(typeof(R2C_RPCTest)));
    public static pb::MessageParser<R2C_RPCTest> Parser { get { return _parser; } }
